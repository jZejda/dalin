        ...
        @php
            ...
            if (!$mapData['eventMap']) {
                ...
                if ($marker->orisId !== null) {
                    ...
                    $popupContent .= '<span class="text-black dark:text-black"><a href="' . OrisApiService::ORIS_URL . '/Zavod?id=' . $marker->orisId . '" style="color:black !important;" target="_blank">Zobrazit na ORISu</a></span>';
                }
            }
