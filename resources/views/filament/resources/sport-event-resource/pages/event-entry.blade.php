...
<x-filament::page>
    ...
    <div
        x-data="{ tab: 'entries', transportFreeSeats: {{ $transportEnabled ? \App\Models\TransportOffer::totalFreeSeatsForEvent($record->id) : 0 }} }"
        x-on:transport-free-seats-changed.window="transportFreeSeats = $event.detail.count"
        class="space-y-4"
    >
        @if ($showTabBar)
        <div class="flex flex-wrap gap-2 border-b border-gray-200 dark:border-gray-700">
            ...
            <button
                ...
                <span
                    x-show="transportFreeSeats > 0"
                    x-cloak
                    x-tooltip="{ content: {{ \Illuminate\Support\Js::from(__('transport.tab_free_seats')) }}, theme: $store.theme }"
                >
                    <x-filament::badge size="sm" color="success">
                        <span x-text="transportFreeSeats"></span>
                    </x-filament::badge>
                </span>
            </button>
            @endif
