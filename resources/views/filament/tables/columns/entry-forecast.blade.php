 ...
 * @description  https://tabler.io/icons
        ...
        <div class="flex flex-row space-x-2 items-center">
            <div>
                <span>
                    ...
                    @elseif($iconString == '02d' || $iconString == '03d' || $iconString == '04d' || $iconString == '02n' || $iconString == '03n' || $iconString == '04n')
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    @elseif($iconString === '09d' || $iconString === '09n' || $iconString === '10d' || $iconString === '10n')
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
