...
<div>
    ...
    @elseif($getRecord()->event_type->value === SportEventType::Training->value)
        <div>
        <span
            class="bg-yellow-100 text-yellow-800 text-sm font-semibold inline-flex items-center p-1.5 rounded-full dark:bg-yellow-800 dark:text-yellow-300">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clock-pin" width="20"
    ...
    @elseif($getRecord()->event_type->value === SportEventType::TrainingCamp->value)
        <div>
            <span
                class="bg-blue-100 text-blue-800 text-sm font-semibold inline-flex items-center p-1.5 rounded-full dark:bg-blue-800 dark:text-blue-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trees" width="20"
                     height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                     stroke-linecap="round" stroke-linejoin="round">
                   <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                   ...
                   <path
                       d="M5.824 16a3 3 0 0 1 -2.743 -3.69a3 3 0 0 1 .304 -4.833a3 3 0 0 1 4.615 -3.707a3 3 0 0 1 4.614 3.707a3 3 0 0 1 .305 4.833a3 3 0 0 1 -2.919 3.695h-4z"></path>
                </svg>
    ...
    @elseif($getRecord()->event_type->value === SportEventType::Other->value)
        <div>
            <span
                class="bg-purple-100 text-purple-800 text-sm font-semibold inline-flex items-center p-1.5 rounded-full dark:bg-purple-800 dark:text-purple-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-help-hexagon" width="20"
                     height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                     stroke-linecap="round" stroke-linejoin="round">
                   <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                   <path
