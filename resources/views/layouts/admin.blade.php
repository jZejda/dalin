    ...
    <div class="font-sans antialiased h-screen flex" id="app">
        ...
        <div class="bg-blue-700 flex-none text-white w-64 hidden md:block">
            ...
            <ul id="menu" class="flex flex-col list-reset">
                ...
                <li class="block">
                    <a href="{{ url('admin/oevents') }}" class="flex-1 flex items-center hover:bg-blue-800 no-underline {{ Request::is('admin/oevents*') ? 'text-white bg-blue-800 border-red-500' : 'text-gray border-blue-700' }} block h-full w-full px-3 py-3 hover:text-white border-l-4 hover:border-red-500">
