...
$url = 'http://127.0.0.1:8000/api/feed/kalendar/zavody/all';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<div class="bash-example">
    ...
    --get "http://127.0.0.1:8000/api/feed/kalendar/zavody/all" \
...
<div class="javascript-example">
    ...
    "http://127.0.0.1:8000/api/feed/kalendar/zavody/all"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://127.0.0.1:8000/api/feed/kalendar/treninky/all';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/feed/kalendar/treninky/all" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/feed/kalendar/treninky/all"
);
