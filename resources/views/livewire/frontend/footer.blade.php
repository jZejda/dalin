...
{{--                        <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo" />--}}
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://abmbrno.cz/" class="hover:underline">{{ config('app.name') }}</a>. Všechna práva vyhrazena. Made with love by <a href="https://gitlab.com/jzejda/dalin" class="hover:underline">dalin</a>
            </span>
