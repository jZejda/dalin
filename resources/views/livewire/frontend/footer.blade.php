<div class="pt-4 bg-gray-200 dark:bg-gray-800">
    <div class="container mx-auto">
        <footer class="p-4 sm:p-6">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            ...
                            <li>
                                <a href="https://abmbrno.cz/stranka/poradane-zavody" class="hover:underline">Poradané závody</a>
                            </li>
                            <li>
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">{{ config('app.name') }}</a>. All Rights Reserved. Made by Laravel, TilwindCss, AlpineJs Filament PHP ...
            </span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://gitlab.com/jzejda/dalin" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
