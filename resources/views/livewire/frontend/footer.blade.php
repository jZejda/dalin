...
{{--                        <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo" />--}}
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">{{ config('app.name') }}</a>. All Rights Reserved. Made by Laravel, TailwindCSS, AlpineJs FilamentPHP
            </span>
