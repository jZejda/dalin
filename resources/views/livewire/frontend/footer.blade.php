...
{{--                        <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo" />--}}
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://abmbrno.cz/" class="hover:underline">{{ config('app.name') }}</a>. Všechna práva vyhrazena. Vyrobeno s láskou <a href="https://jirizejda.cz/dalin" class="hover:underline underline">dalin</a>
            </span>
